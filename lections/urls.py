...
from .views import (get_profile_lections,
                    ...
                    get_lection_content_insert_paragraph,
...
urlpatterns = [
    ...
    path('<slug:lection_slug>/content-insert-middle/', get_lection_content_insert_paragraph, name='get_lection_content_insert_paragraph'),
